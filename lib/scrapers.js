      ...
      $('.challenge-card, .challenge-card-modern').each((i, el) => {
        ...
        if (name && link) {
          results.push({
            ...
            registrationLink: (link && typeof link === 'string' && link.startsWith('http')) ? link : `https://hackerearth.com${link}`,
          });
        }
      });
      return results;
      ...
      $('.event-card, .hackathon-card').each((i, el) => {
        ...
        if (name && link) {
          results.push({
            ...
            registrationLink: (link && typeof link === 'string' && link.startsWith('http')) ? link : `https://reskilll.com${link}`,
          });
        }
      });
      return results;
